...
ansible-playbook -i ../01_hetzner/terraform-swarm-inventory.py --key-file $HOME/.ssh/github_actions swarm_setup.yml
cd ..

cd 03_stacks
ansible-playbook -i ../01_hetzner/terraform-swarm-inventory.py --key-file $HOME/.ssh/github_actions deploy_basics.yml
